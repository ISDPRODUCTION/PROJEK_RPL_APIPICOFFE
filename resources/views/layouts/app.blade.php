...
@php
    ...
    // Admin TIDAK bisa akses dashboard, tapi bisa akses menu, reports, settings
    $isAdmin    = in_array($userRole, ['admin', 'manager', 'supervisor']);
    // Kasir HANYA bisa akses dashboard & settings (tidak bisa akses menu management)
    $isCashier  = $userRole === 'cashier';
    // Dashboard hanya untuk kasir, manager, supervisor (bukan admin)
    $canSeeDashboard = in_array($userRole, ['cashier', 'manager', 'supervisor']);
@endphp
